...
export const assignLead = (id, assignedToId) => apiFetch(`/leads/${id}/assign`, { method: "PATCH", body: { assignedToId: assignedToId === "" ? null : assignedToId } });
...
export const markProspect = (id, reason) => apiFetch(`/leads/${id}/prospect`, { method: "PATCH", body: { reason } });
export const unmarkProspect = (id) => apiFetch(`/leads/${id}/unprospect`, { method: "PATCH" });
...
export const listReminders = (range = "all", limit = 50) => apiFetch(withQuery("/leads/reminders", { range, limit, todayStart: localTodayStart() }));
export const getUnreadReminderCount = () => apiFetch("/leads/reminders/unread-count");
export const markRemindersSeen = (followUpIds) => apiFetch("/leads/reminders/seen", { method: "POST", body: { followUpIds } });
